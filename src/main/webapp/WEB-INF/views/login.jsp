			...
			<form id="login_form" action="${APP_PATH }/login" method="post" >
				<div class="group">
					<div class="group-ipt user" >
						<input type="name" name="username" id="username" class="ipt" placeholder="输入登录用户名" required>
					</div>
					<div class="group-ipt password">
						<input type="password" name="password" id="password" class="ipt" placeholder="输入登录密码" required>
					</div>
					<div class="group-ipt verify">
						<input type="text" name="valistr" id="verify" class="ipt" placeholder="输入验证码" required>
				...
				<div class="remember clearfix">
					<label class="remember-me">
						...
						<span style="color:#555">记住用户名</span>
					</label>
				</div>
			</form>
		</div>
